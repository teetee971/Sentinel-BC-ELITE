...
export const metadata: Metadata = {
	...
	description:
		"Plateforme cyberdéfense BC-ELITE : supervision quantique, IA militaire et défense réseau autonome.",
	keywords: [
		"cyberdéfense",
		"BC-ELITE",
		"Sentinel",
	...
	openGraph: {
		...
		description:
			"Plateforme cyberdéfense niveau militaire avec moteur neuronal et surveillance temps réel.",
		...
		<html lang="fr" data-theme="bc-elite">
			...
			>
				...
				<div className="relative flex min-h-screen flex-col overflow-hidden">
					<div aria-hidden className="depth-layer" />
					<div aria-hidden className="scan-line" />
					<div
						aria-hidden
						className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top,rgba(0,234,255,0.12),transparent_65%)]"
					/>
					<div
						aria-hidden
						className="pointer-events-none absolute inset-x-0 bottom-0 -z-10 h-[420px] bg-gradient-to-t from-cyan-500/15 via-cyan-500/5 to-transparent blur-[140px]"
					/>
